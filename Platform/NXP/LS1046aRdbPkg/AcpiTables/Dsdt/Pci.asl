...
Scope(_SB)
{
  ...
  Device (PCI0) {
    ...
    // NXP PCIe RC config base address
    Device (RES0) {
      Name (_HID, "NXP0016")
      Name (_CRS, ResourceTemplate () {
        Memory32Fixed (ReadWrite,
                       LS1046A_PCI_SEG0_RC_CONFIG_BASE,
                       LS1046A_PCI_SEG0_RC_CONFIG_SIZE)
      })
    }

    // PCI Routing Table
    Name (_PRT, Package () { // Single Legacy Interrupt
            Package () { 0xFFFF, 0, Zero, LS1046A_PCI_SEG0_INTA },   // INTA
            Package () { 0xFFFF, 1, Zero, LS1046A_PCI_SEG0_INTA },   // INTA
            Package () { 0xFFFF, 2, Zero, LS1046A_PCI_SEG0_INTA },   // INTA
            Package () { 0xFFFF, 3, Zero, LS1046A_PCI_SEG0_INTA },   // INTA
            })
    //
    // OS Control Handoff
    //
  ...
  Device (RES0) {
    ...
    Name (_CRS, ResourceTemplate () {
      Memory32Fixed (ReadWrite, LS1046A_PCI_SEG0_RC_CONFIG_BASE,
              LS1046A_PCI_SEG0_RC_CONFIG_SIZE)
    })
  }
