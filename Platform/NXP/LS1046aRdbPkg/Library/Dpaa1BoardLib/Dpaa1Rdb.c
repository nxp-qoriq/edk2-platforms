...
MMIO_OPERATIONS *mMemoryOpsDpaa1Rdb;
  ...
  )
{
  ...
  mMemoryOpsDpaa1Rdb = GetMmioOperations (FeaturePcdGet (PcdDpaaBigEndian));

  RegValue = mMemoryOpsDpaa1Rdb->Read32((UINTN)&Gur->DevDisr2);
