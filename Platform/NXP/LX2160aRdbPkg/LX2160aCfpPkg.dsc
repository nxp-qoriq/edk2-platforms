...
[Defines]
  ...
  # -D FLAG=VALUE
  #
  PLATFORM_NAME                  = LX2160aCfpPkg
  PLATFORM_GUID                  = be06d8bc-05eb-44d6-b39f-191e93617ebd
  OUTPUT_DIRECTORY               = Build/LX2160aCfpPkg
  FLASH_DEFINITION               = Platform/NXP/LX2160aRdbPkg/LX2160aCfpPkg.fdf
...
!endif
  ...
  gArmPlatformTokenSpaceGuid.PL011UartFractional|0xd
