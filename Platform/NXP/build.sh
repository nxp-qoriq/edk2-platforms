...
cat $WORKSPACE/Build/$1$PKG/$3"_"$TARGET_TOOLS/FV/$1A$2_EFI.fd >> $WORKSPACE/Build/$1$PKG/$3"_"$TARGET_TOOLS/FV/$1A$2PI_EFI.fd
mv $WORKSPACE/Build/$1$PKG/$3"_"$TARGET_TOOLS/FV/$1A$2PI_EFI.fd $WORKSPACE/Build/$1$PKG/$3"_"$TARGET_TOOLS/FV/$1A$2_EFI.fd
